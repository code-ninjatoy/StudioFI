<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CSlideBar.ascx.cs" Inherits="Controls_CSlideBar" %>
...
<div class="sidebar">
    <div class="sidebar-content">
            ...
            <ItemTemplate>
                ...
                <div class="user-menu dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src='<%# "images/UserImages/" + Eval("ProfilePic") %>' alt="">
                        <div class="user-info">
                            <h6><%#Eval("UserName") %></h6>
                        </div>
                    </a>
                    <div class="popup dropdown-menu dropdown-menu-right">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item"><i class="icon-pencil3 text-muted"></i>My posts <span class="label label-success">3</span></li>
                            <li class="list-group-item"><i class="icon-people text-muted"></i>My Bookshoot<span class="label label-danger">3</span></li>
                            <%--<li class="list-group-item"><i class="icon-stats2 text-muted"></i>Reports <span class="label label-primary">92</span></li>
                            <li class="list-group-item"><i class="icon-stack text-muted"></i>Balance<h5 class="pull-right text-danger">$45.389</h5>
                            </li>--%>
                        </ul>
                    </div>
                </div>
        ...
        <!-- Main navigation -->
        <ul class="navigation">
            <li><a href="Default.aspx"><span>Back To FIStudio</span> <i class="icon-screen2"></i></a></li>
            <li><a href="ClientProfile.aspx"><span>Dashboard</span> <i class="icon-screen2"></i></a></li>
            <li>
                <a href="ClientPricing.aspx"><span>My Pricing</span> <i class="icon-grid"></i></a>
                <%--<ul>
            ...
            <li>
                <a href="AddBooking.aspx"><span>My Booking</span> <i class="icon-paragraph-justify2"></i></a>
                <%--<ul>
                    <li><a href="AddBooking.aspx">Book Now</a></li>
                    <li><a href="sidebar_wide_right.html">Booking History</a></li>
                </ul>--%>
            </li>
            <li>
                <a href="AddDiary.aspx"><span>My Diary</span> <i class="icon-copy"></i></a>
               <%-- <ul>
                    <li><a href="AddDiary.aspx">Add New My Diary</a></li>
                    <li><a href="ViewMyDiary.aspx">View All My Diary</a></li>
                </ul>--%>
            </li>
            <li><a href="ReferMyFriend.aspx"><span>Refer To My Friend</span> <i class="icon-screen2"></i></a></li>
            <li>
                <asp:LinkButton ID="lnbLogout" runat="server" OnClick="lnbLogout_Click"><i class="icon-key"></i>Logout</asp:LinkButton>
                <%--<ul>
