<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CNavBar.ascx.cs" Inherits="Controls_CNavBar" %>

<!-- Navbar -->
<div class="navbar navbar-inverse" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand" href="#" title="FI">FI Studio
           <%-- <img src="images/D_logo2.png" alt="FI Studio">--%></a>
            ...
            <ItemTemplate>
                ...
                <li class="user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right icons-right">
                        <li><a href="ClientEditProfile.aspx"><i class="icon-user"></i>Profile</a></li>
                        <li><a href="DeactivateAcc.aspx"><i class="icon-user"></i>Deactivation</a></li>
                        <%--<li><a href="#"><i class="icon-bubble4"></i>Change Password</a></li>
                <li><a href="#"><i class="icon-cog"></i>Settings</a></li>--%>
                        <li>
                            <asp:LinkButton ID="lnbLogout" runat="server" OnClick="lnbLogout_Click"><i class="icon-exit"></i>Logout</asp:LinkButton></li>
                    </ul>
                </li>
            </ItemTemplate>
        </asp:Repeater>
